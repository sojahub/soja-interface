        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>
                Get fee discounts and earn rebates through the FMX referral program.
                <br />
                For more information, please read the{" "}
                <ExternalLink href="https://fmxio.gitbook.io/fmx/referrals">referral program details</ExternalLink>.
              </Trans>
            </div>
          </div>
        </div>
